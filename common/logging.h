...
//   }
// 
// #define CHECK_EQ(ret, condition) CHECK(ret == condition)
// 
// const int DEBUG = 0;
// const int INFO = 1;
// const int WARNING = 2;
...
// const int FATAL = 4;
// 
// #define _LOG_DEBUG ::runtime::LogMessage(__FILE__, __LINE__, ::runtime::DEBUG)
// #define _LOG_INFO ::runtime::LogMessage(__FILE__, __LINE__, ::runtime::INFO)
// #define _LOG_WARNING \
//   ::runtime::LogMessage(__FILE__, __LINE__, ::runtime::WARNING)
// #define _LOG_ERROR ::runtime::LogMessage(__FILE__, __LINE__, ::runtime::ERROR)
// #define _LOG_FATAL ::runtime::LogMessage(__FILE__, __LINE__.::runtime::FATAL)
// 
